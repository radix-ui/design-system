...
export const theme = {
  colors: {
    ...
    $white300: 'hsla(0, 0%, 100%, .3)',
    $white400: 'hsla(0, 0%, 100%, .4)',
    $white500: 'hsla(0, 0%, 100%, .5)',
    $white600: 'hsla(0, 0%, 100%, .6)',
    $white700: 'hsla(0, 0%, 100%, .7)',
    $white800: 'hsla(0, 0%, 100%, .8)',
    $white900: 'hsla(0, 0%, 100%, .9)',

    $black100: 'hsla(0, 0%, 0%, .025)',
    $black200: 'hsla(0, 0%, 0%, .05)',
    $black300: 'hsla(0, 0%, 0%, .08)',
    $black400: 'hsla(0, 0%, 0%, .1)',
    $black500: 'hsla(0, 0%, 0%, .15)',
    $black600: 'hsla(0, 0%, 0%, .25)',
    $black700: 'hsla(0, 0%, 0%, .45)',
    $black800: 'hsla(0, 0%, 0%, .6)',
    $black900: 'hsla(0, 0%, 0%, .75)',
    ...
    $grayViolet100: 'hsl(252, 17%, 98.8%)',
    $grayViolet200: 'hsl(252, 11%, 96.0%)',
    $grayViolet300: 'hsl(252, 9%, 93.7%)',
    $grayViolet400: 'hsl(252, 9%, 92.0%)',
    $grayViolet500: 'hsl(252, 8%, 89.5%)',
    $grayViolet600: 'hsl(252, 8%, 85.2%)',
    $grayViolet700: 'hsl(252, 8%, 80.0%)',
    $grayViolet800: 'hsl(252, 4%, 56.1%)',
    $grayViolet900: 'hsl(252, 4%, 43.9%)',

    $grayBlue100: 'hsl(206, 20%, 98.8%)',
    $grayBlue200: 'hsl(206, 14%, 96.0%)',
    $grayBlue300: 'hsl(206, 13%, 93.7%)',
    $grayBlue400: 'hsl(206, 12%, 92.0%)',
    $grayBlue500: 'hsl(206, 12%, 89.5%)',
    $grayBlue600: 'hsl(206, 11%, 85.2%)',
    $grayBlue700: 'hsl(206, 10%, 80.0%)',
    $grayBlue800: 'hsl(206, 6%, 56.1%)',
    $grayBlue900: 'hsl(206, 6%, 43.9%)',

    $grayYellow100: 'hsl(50, 20%, 98.8%)',
    $grayYellow200: 'hsl(50, 14%, 96.0%)',
    $grayYellow300: 'hsl(50, 13%, 93.7%)',
    $grayYellow400: 'hsl(50, 12%, 92.0%)',
    $grayYellow500: 'hsl(50, 12%, 89.5%)',
    $grayYellow600: 'hsl(50, 11%, 85.2%)',
    $grayYellow700: 'hsl(50, 10%, 80.0%)',
    $grayYellow800: 'hsl(50, 6%, 56.1%)',
    $grayYellow900: 'hsl(50, 6%, 43.9%)',
