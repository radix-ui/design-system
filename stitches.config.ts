...
export const flatTheme = theme('flat-theme', {
  colors: {
    ...
    buttonColorAccent: 'white',
    buttonColorPositive: 'white',
    buttonColorWarning: 'white',
  },
  shadows: {
    buttonShadow: '0 0 0 0',
    buttonShadowHover: '0 0 0 0',
  },
  radii: {
    buttonRadius: '3px',
  },
...
export const softTheme = theme('soft-theme', {
  colors: {
    buttonBackgroundPlain: '$slate200',
    buttonBackgroundAccent: '$blue200',
    buttonBackgroundPositive: '$green200',
    buttonBackgroundWarning: '$red200',

    buttonBackgroundPlainHover: '$slate300',
    buttonBackgroundAccentHover: '$blue300',
    buttonBackgroundPositiveHover: '$green300',
    buttonBackgroundWarningHover: '$red300',

    buttonColorPlain: '$hiContrast',
    buttonColorAccent: '$blue900',
    buttonColorPositive: '$green900',
    buttonColorWarning: '$red900',

    buttonBorderColorPlain: 'transparent',
    buttonBorderColorAccent: 'transparent',
    buttonBorderColorPositive: 'transparent',
    buttonBorderColorWarning: 'transparent',

    buttonBorderColorPlainHover: 'transparent',
    buttonBorderColorAccentHover: 'transparent',
    buttonBorderColorPositiveHover: 'transparent',
    buttonBorderColorWarningHover: 'transparent',
  },
  shadows: {
    buttonShadow: '0 0 0 0',
    buttonShadowHover: '0 0 0 0',
...
export const modulzTheme = theme('modulz-theme', {
  colors: {
    ...
    buttonBorderColorPlain: '$slate600',
    buttonBorderColorAccent: '$blue600',
    buttonBorderColorPositive: '$green600',
    buttonBorderColorWarning: '$slate600',

    buttonBorderColorPlainHover: '$slate700',
    buttonBorderColorAccentHover: '$blue700',
    buttonBorderColorPositiveHover: '$green700',
    buttonBorderColorWarningHover: '$slate700',
  },
  shadows: {
    buttonShadow: '0 0 0 0',
    buttonShadowHover: '0 0 0 0',
...
export const coolTheme = theme('cool-theme', {
  colors: {
    buttonBackgroundPlain: '$loContrast',
    buttonBackgroundAccent: '$loContrast',
    buttonBackgroundPositive: '$loContrast',
    buttonBackgroundWarning: '$loContrast',

    buttonBackgroundPlainHover: '$loContrast',
    buttonBackgroundAccentHover: '$loContrast',
    buttonBackgroundPositiveHover: '$loContrast',
    buttonBackgroundWarningHover: '$loContrast',
  ...
  shadows: {
    buttonShadow: '0 3px 15px -5px',
    buttonShadowHover: '0 5px 25px -5px',
  },
  radii: {
    buttonRadius: '9999px',
  },
